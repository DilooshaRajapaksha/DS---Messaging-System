...
storage and /recover endpoint. (Identical role to server2)
...
def recover():
    ...
    When this backup rejoins after a crash, it syncs all
    missed messages from the primary's /sync endpoint.
    """
    try:
